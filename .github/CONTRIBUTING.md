...
```sh
git clone https://github.com/CCBR/MOSuite-nxf
```

> Cloning into 'MOSuite-nxf'... <br>
...
> remote: https://github.com/CCBR/MOSuite-nxf/pull/new/iss-10 <br>
> remote: <br>
> To https://github.com/CCBR/MOSuite-nxf <br> > <br> > [new branch] iss-10 -> iss-10 <br>
